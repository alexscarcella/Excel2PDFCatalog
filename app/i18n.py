...
TRANSLATIONS = {
    "it": {
        ...
        "dialog.building.title": "Generazione in corso",
        "dialog.building.msg": "Generazione del PDF in corso…",
        "dialog.building.activity": "Attività in corso (categoria › produttore › prodotto):",
        "dialog.open_failed.msg": "Impossibile aprire: {path}",
        "btn.open_file": "Apri file",
        "btn.open_folder": "Apri cartella",
        "btn.close": "Chiudi",
    ...
    "en": {
        ...
        "dialog.building.title": "Building",
        "dialog.building.msg": "Building the PDF…",
        "dialog.building.activity": "Current activity (category › manufacturer › product):",
        "dialog.open_failed.msg": "Cannot open: {path}",
